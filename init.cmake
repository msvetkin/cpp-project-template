...
function(print_help)
  message(FATAL_ERROR "usage: cmake -P init.cmake --project <name> --module <name> --header <name>")
endfunction()
...
if (DEFINED arg_UNPARSED_ARGUMENTS OR
    (NOT DEFINED arg_--project OR NOT DEFINED arg_--module OR NOT DEFINED arg_--header))
  print_help()
endif()
